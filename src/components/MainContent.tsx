...
// Update the mock quiz data to match the mathematical questions
const mockQuizData = [
  {
        ...
        <CardContent>
          <div className="prose dark:prose-invert">
            <p>
              ...
              would go. The content here would be tailored to engage young learners, using simple language and relatable
              examples.
            </p>
            <p>
              Interactive elements, such as quizzes or mini-games, could be embedded here to reinforce learning and make
